...
namespace SyncfusionMvcASplineGraphApplication1.Controllers
{
    ...
    public partial class ChartController : Controller
    {
        ...
        public ActionResult ChartFeatures()
        {
            ...
            //    else
            //        value -= n;
            //    points.Add(new Point() { x = i, y = value, bubbleSize = n });
            //}
        ...
        public ActionResult MultipleSeries()
        {
            ...
            ViewBag.series2 = new List<ColumnChartData>()
            {
            ...
            //ViewBag.series3 = new SplineGraphData().GetSpSplineGraphDataObjects();
