...
namespace SyncfusionMvcApplicationRichTextEditor3.Controllers
{
    public partial class KanbanController : Controller
    {
        ...
        {
            List<KanbanDataModels> dataModels = new KanbanDataModels().GetSpKanbanDataObjects();//.KanbanCardTasks();//.GetSpKanbanDataObjects();////.();
            ViewBag.data = dataModels;
        ...
        {
              ViewBag.data = new KanbanDataModels().GetSpKanbanDataObjects();//.KanbanTasks();
            return View();
        }        
    }
    /*
